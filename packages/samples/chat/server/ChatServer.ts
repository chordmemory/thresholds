...
import { thresholdFn, thresholdManifest } from '@threshold-libs/main';
import { HttpServerOptions } from '@threshold-transports/http/server';
...
export class ChatServer {
    ...
    @thresholdFn<HttpServerOptions>({
        ...
        options: {
            ...
            method: 'POST',
            paramMapper: ((params, body) => [ params.chatId, ...body ])
        }
    })
