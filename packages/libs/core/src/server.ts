import { ServiceClientManifest, ServerTransport, ServerThresholdConfig, ThresholdClientConfig } from "@threshold-types/core";
...
export const startThreshold = async (config: ServerThresholdConfig<unknown>, map: TransportMap): Promise<ThresholdClientConfig<unknown>> => {
...
export const startService = async (service: Object, map: TransportMap) => {
    ...
    const thresholds: ServerThresholdConfig<unknown>[] = Reflect.getMetadata('thresholds', service) || [];
